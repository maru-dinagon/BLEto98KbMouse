#ifndef   PC98BLEKBDRPTPARSER_HPP
#define   PC98BLEKBDRPTPARSER_HPP
...
class Pc98BLEKbdRptParser
{
  ...
  public:
    void Parse(uint8_t len __attribute__((unused)), uint8_t *buf);
